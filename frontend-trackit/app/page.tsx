...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white text-gray-900 flex flex-col">
      <header className="sticky top-0 z-50 w-full border-b border-gray-300 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 flex-none">
      ...
      <AuroraBackground>
        <main className="flex-1 overflow-hidden">
          <section className="relative overflow-hidden py-20 h-full flex items-center justify-center">
            <div className="container relative z-10 text-center">
              <div className="mx-auto flex max-w-fit items-center gap-2 rounded-full bg-gray-200/50 px-4 py-2 backdrop-blur">
      ...
      <footer className="border-t border-gray-300 flex-none">
        <div className="container flex h-16 items-center justify-between">
